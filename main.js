...
var fechAgendaCita = "";
var nombreHTMLFinal="";
var urlREST = "http://quiromedico.com/ApiQuiroMedico/";
...
s1.async=true;
s1.src='https://embed.tawk.to/5d2e2904bfcb827ab0cc1ecd/default';
s1.charset='UTF-8';
...
function creaTipoCitas(varTipoCitas) {
	...
	for (var i = 0; i < obj.length; i++) {
		$("#divContainerTipoCitas").append('<div class="col-md-6"><button type="button" class="btn-accent" onclick="escojeTipoCitas(\'' + obj[i].FCNOMBRETIPOCITA + '\',' + obj[i].FITIPOCITAID +' , '+  obj[i].FCNOMBREHTML + ' , ' + obj[i].FCDIASCITAS + ')">' + obj[i].FCNOMBRETIPOCITA + '</button></div>');
	}
}
...
function enviarCorreoCita(){

	var mensajeSujeto = "QuiroMedico alta de cita para "+tipoCitaString +" a las: " + horariosstr;   
	var mensajeCuerpo =  "Hola "+ nombre+ "! se registro para la alta de la cita para " +tipoCitaString +" a las: " + horariosstr + " de forma correcta, uno de nuestros terapeutas se contactara con usted para confirmar la cita";
 ...
 Email.send({
    SecureToken : "a98f071e-ea4f-4747-a205-494aba037628",
    To : emailS,
    From : "citas@quiromedico.com",
    Subject : mensajeSujeto,
    Body : mensajeCuerpo
});

mensajeCuerpo= "Hola! favor de confirmar la cita para " +tipoCitaString +" a las: " + horariosstr + " con "+nombre+" al telefono "+ telefono + " con los comenctario : "+comentarios;
 Email.send({
    SecureToken : "a98f071e-ea4f-4747-a205-494aba037628",
    To : "citas@quiromedico.com",
    From : "citas@quiromedico.com",
    Subject : mensajeSujeto,
    Body : mensajeCuerpo
});
...
debugger;
 ...
 Email.send({
    SecureToken : "33edab21-f787-4f02-a060-5d487c89d42f",
    To : emailS,
    From : "contacto@quiromedico.com",
    Subject : mensajeSujeto,
    Body : mensajeCuerpo
});
